...
- Real terminal-browser routing, desktop split, mobile sheet persistence, tabs, frames, DevTools, Record, cursor, refresh, and cleanup: `test/terminal-browser.spec.js`
